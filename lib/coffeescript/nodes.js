...
// multiline need to be indented.
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      // function body.
      compileNode(o) {
        var answer, body, boundMethodCheck, comment, condition, exprs, generatedVariables, haveBodyParam, haveSplatParam, i, ifTrue, j, k, l, len1, len2, len3, len4, m, methodScope, modifiers, name, p, param, paramToAddToScope, params, paramsAfterSplat, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, scopeVariablesCount, signature, splatParamName, thisAssignments, typeParam, wasEmpty, yieldNode;
        ...
        // `function` and `(`.
        if (((ref7 = this.paramStart) != null ? ref7.comments : void 0) != null) {
          this.compileCommentFragments(o, this.paramStart, signature);
        }
        for (i = l = 0, len3 = params.length; l < len3; i = ++l) {
          param = params[i];
          if (i !== 0) {
            signature.push(this.makeCode(', '));
          }
        ...
        if (((ref8 = this.funcGlyph) != null ? ref8.comments : void 0) != null) {
          ref9 = this.funcGlyph.comments;
        ...
        answer = this.joinFragmentArrays((function() {
          var len5, q, results1;
          results1 = [];
          for (q = 0, len5 = modifiers.length; q < len5; q++) {
            m = modifiers[q];
