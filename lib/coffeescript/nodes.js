...
// multiline need to be indented.
  ...
  exports.ExplicitTypeUndefined = ExplicitTypeUndefined = class ExplicitTypeUndefined extends UndefinedLiteral {
    compileNode(o) {
      return [this.makeCode('undefined')]; // can't use void 0 as a type
    }
