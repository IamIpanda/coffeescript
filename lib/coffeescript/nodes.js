  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileWithDeclarations(o) {
        var assigned, declare, exp, fragments, i, j, len1, post, ref1, rest, scope, spaced, unassigned;
        fragments = [];
        post = [];
        ref1 = this.expressions;
        ...
        if (scope.expressions === this) {
          if (o.scope.hasDeclarations()) {
            ...
            declare = (names, sep) => {
              var k, len2, name, results1, v;
              results1 = [];
              for (i = k = 0, len2 = names.length; k < len2; i = ++k) {
                name = names[i];
                v = scope.get(name);
                ...
                if (v.explicitType != null) {
                  fragments.push(this.makeCode(": "), ...v.explicitType);
                }
                if (v.assigned != null) {
...
// multiline need to be indented.
  ...
  // variable ~ Type
  exports.AssignExplicitType = AssignExplicitType = (function() {
    class AssignExplicitType extends Base {
      constructor(identifier, explicitType) {
        super();
        this.identifier = identifier;
        this.explicitType = explicitType;
        this.hoisted = true; // if this is the whole line in a Block, omit identifier
      }

      eachName(iterator) {
        return this.identifier.eachName(iterator);
      }

      compileNode(o) {
        var message, name, oldType;
        name = this.identifier.value;
        message = isUnassignable(name);
        if (message) {
          this.identifier.error(message);
        }
        Assign.prototype.checkNameAssignability(o, name);
        if (o.scope.type(name) === 'param') {
          this.explicitType.error(`Attempt to assign parameter ${name} explicit type`);
        }
        o.scope.add(name, 'var');
        if ((oldType = o.scope.getExplicitType(name)) != null) {
          this.explicitType.error(`Variable ${name} assigned multiple explicit types: previously ${fragmentsToText(oldType)} at ${locationDataToString(oldType[0].locationData)}`);
        }
        o.scope.explicitType(name, this.explicitType.compileNode(o));
        return this.identifier.compileNode(o);
      }
    ...
    AssignExplicitType.prototype.children = ['identifier', 'explicitType'];

    AssignExplicitType.prototype.isAssignable = YES;

    return AssignExplicitType;

  }).call(this);

  // Renders as `variable: explicitType`, for inclusion in Assign as Parameter
  exports.WithExplicitType = WithExplicitType = class WithExplicitType extends AssignExplicitType {
    compileNode(o) {
      return [...this.identifier.compileNode(o), this.makeCode(': '), ...this.explicitType.compileNode(o)];
    }
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      constructor(variable1, parent1, body1, typeParams) {
        super();
        this.variable = variable1;
        this.parent = parent1;
        this.body = body1;
      ...
      compileClassDeclaration(o) {
        ...
        if (this.typeParams != null) {
          result.push(...this.typeParams.compileToFragments(o));
        }
    ...
    Class.prototype.children = ['variable', 'parent', 'body', 'typeParams'];
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      compileNode(o) {
            ...
            if (!haveSplatParam) {
              ...
              if (param.shouldCache()) {
                ...
                if ((param.value != null) && !param.assignedInBody) {
                  ref = param.name;
                  if (param.explicitType != null) {
                    ref = new WithExplicitType(ref, param.explicitType);
                  }
                  ref = new Assign(new Value(ref), param.value, null, {
                    param: true
                  });
                } else {
                  ref = param;
        ...
        signature = [];
        if (this.typeParams != null) {
          signature.push(...this.typeParams.compileToFragments(o));
        }
        ...
        if (this.explicitType != null) {
          signature.push(this.makeCode(': '));
          signature.push(...this.explicitType.compileNode(o));
        }
  ...
  exports.Param = Param = (function() {
    class Param extends Base {
      constructor(name1, explicitType, value1, splat1, question) {
        var message, token;
        super();
        this.name = name1;
        this.explicitType = explicitType;
      ...
      compileToFragments(o) {
        var fragments;
        fragments = this.name.compileToFragments(o, LEVEL_LIST);
        if (this.question != null) {
          fragments.push(this.makeCode('?'));
        }
        if (this.explicitType != null) {
          fragments.push(this.makeCode(': '), ...this.explicitType.compileToFragments(o, LEVEL_LIST));
        }
        return fragments;
      }
    ...
    Param.prototype.children = ['name', 'explicitType', 'value'];
  ...
  exports.ExplicitTypeIdentifier = ExplicitTypeIdentifier = class ExplicitTypeIdentifier extends IdentifierLiteral {};

  exports.ExplicitTypeLiteral = ExplicitTypeLiteral = (function() {
    class ExplicitTypeLiteral extends Base {
      ...
      compileNode(o) {
        switch (this.literal.constructor.name) {
          case 'UndefinedLiteral':
            return [this.makeCode('undefined')]; // `void 0` is an invalid type
          case 'InfinityLiteral':
            return [this.makeCode('Infinity')]; // instead of '2e308'
          case 'NaNLiteral':
            return [this.makeCode('NaN')]; // instead of '0/0'
          default:
            return this.literal.compileNode(o);
        }
      }

    };

    ExplicitTypeLiteral.prototype.children = ['literal'];

    return ExplicitTypeLiteral;

  }).call(this);

  // UndefinedLiteral uses void 0, which is an invalid type
  exports.ExplicitTypeUndefined = ExplicitTypeUndefined = class ExplicitTypeUndefined extends Literal {
    constructor() {
      super('undefined');
    }
  ...
  exports.ExplicitTypeVoid = ExplicitTypeNull = class ExplicitTypeNull extends Literal {
    constructor() {
      super('void');
    }
  ...
  exports.ExplicitTypeFunction = ExplicitTypeFunction = (function() {
    class ExplicitTypeFunction extends Base {
      constructor(params1, body1, funcGlyph) {
        super();
        this.params = params1;
        this.body = body1;
        this.funcGlyph = funcGlyph;
      ...
      compileNode(o) {
        var fragments, i, j, len1, param, ref1;
        fragments = [];
        fragments.push(this.makeCode('('));
        ref1 = this.params;
        for (i = j = 0, len1 = ref1.length; j < len1; i = ++j) {
        ...
        fragments.push(this.makeCode(') => '));
        fragments.push(...this.body.compileToFragments(o, LEVEL_PAREN));
        return fragments;
      }

    };

    ExplicitTypeFunction.prototype.children = ['params', 'body'];

    return ExplicitTypeFunction;

  }).call(this);

  exports.ExplicitTypeArray = ExplicitTypeArray = (function() {
    class ExplicitTypeArray extends Base {
      constructor(base1) {
        super();
        this.base = base1;
      }
      ...
      compileNode(o) {
        var fragments;
        fragments = this.base.compileNode(o);
        fragments.push(this.makeCode('[]'));
        return fragments;
      }
    ...
    ExplicitTypeArray.prototype.children = ['base'];

    return ExplicitTypeArray;

  }).call(this);

  // T['foo'] and aNamespace.T
  exports.ExplicitTypeAccess = ExplicitTypeAccess = (function() {
    class ExplicitTypeAccess extends Base {
      constructor(base1, property1) {
        super();
        this.base = base1;
        this.property = property1;
      }
      ...
      compileNode(o) {
        return [...this.base.compileToFragments(o, LEVEL_ACCESS), ...this.property.compileToFragments(o)];
      }

    };

    ExplicitTypeAccess.prototype.children = ['base', 'property'];

    return ExplicitTypeAccess;

  }).call(this);

  exports.ExplicitTypeGeneric = ExplicitTypeGeneric = (function() {
    class ExplicitTypeGeneric extends Base {
      constructor(base1, _arguments) {
        super();
        this.base = base1;
      ...
      compileNode(o) {
        var argument, fragments, i, j, len1, ref1;
        fragments = this.base.compileNode(o);
        fragments.push(this.makeCode('<'));
        ref1 = this.arguments;
        for (i = j = 0, len1 = ref1.length; j < len1; i = ++j) {
    ...
    ExplicitTypeGeneric.prototype.children = ['base', 'arguments'];

    return ExplicitTypeGeneric;

  }).call(this);

  // `T = S` in generic < ... >.  Avoid variable declaration like Assign.
  exports.ExplicitTypeAssign = ExplicitTypeAssign = (function() {
    class ExplicitTypeAssign extends Base {
      ...
      compileNode(o) {
        return [...this.variable.compileNode(o), this.makeCode(' = '), ...this.value.compileNode(o)];
      }

    };

    ExplicitTypeAssign.prototype.children = ['variable', 'value'];

    return ExplicitTypeAssign;

  }).call(this);

  exports.ExplicitTypeParameters = ExplicitTypeParameters = (function() {
    class ExplicitTypeParameters extends Base {
      ...
      compileNode(o) {
        var fragments, i, j, len1, parameter, ref1;
        fragments = [];
        fragments.push(this.makeCode('<'));
    ...
    ExplicitTypeParameters.prototype.children = ['parameters'];

    return ExplicitTypeParameters;

  }).call(this);

  exports.ExplicitTypeOp = ExplicitTypeOp = (function() {
    class ExplicitTypeOp extends Base {
      constructor(operator, first1, second1) {
        super();
      ...
      compileNode(o) {
        if (this.isUnary()) {
          return [this.makeCode(`${this.operator} `), ...this.first.compileNode(o)];
        } else {
          return [...this.first.compileNode(o), this.makeCode(` ${this.operator} `), ...this.second.compileNode(o)];
        }
      }

    };

    ExplicitTypeOp.prototype.children = ['first', 'second'];

    return ExplicitTypeOp;

  }).call(this);

  exports.ExplicitTypeParens = ExplicitTypeParens = (function() {
    class ExplicitTypeParens extends Base {
      constructor(body1) {
        super();
        this.body = body1;
      }
    ...
    ExplicitTypeParens.prototype.children = ['body'];

    return ExplicitTypeParens;

  }).call(this);

  exports.ExplicitTypeObject = ExplicitTypeObject = (function() {
    class ExplicitTypeObject extends Base {
      ...
      compileNode(o) {
        var fragments, i, j, len1, prop, ref1;
        fragments = [];
        fragments.push(this.makeCode('{'));
        ref1 = this.properties;
        for (i = j = 0, len1 = ref1.length; j < len1; i = ++j) {
    ...
    ExplicitTypeObject.prototype.children = ['properties'];

    return ExplicitTypeObject;

  }).call(this);

  exports.ExplicitTypeObjectProp = ExplicitTypeObjectProp = (function() {
    class ExplicitTypeObjectProp extends Base {
      constructor(variable1, value1, optional) {
        super();
        this.variable = variable1;
        this.value = value1;
      ...
      compileNode(o) {
        var fragments;
        fragments = [];
        fragments.push(...this.variable.compileNode(o));
        if (this.optional) {
          fragments.push(this.makeCode('?'));
        }
        fragments.push(this.makeCode(': '));
        fragments.push(...this.value.compileNode(o));
        return fragments;
      }

    };

    ExplicitTypeObjectProp.prototype.children = ['variable', 'value'];

    return ExplicitTypeObjectProp;
