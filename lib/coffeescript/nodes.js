...
// multiline need to be indented.
  ...
  exports.ExplicitType = ExplicitType = (function() {
    class ExplicitType extends Base {
    ...
    ExplicitType.prototype.children = ['identifier', 'explicitType'];
