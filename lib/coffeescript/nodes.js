  ...
  exports.Param = Param = (function() {
    class Param extends Base {
      ...
      compileToFragmentsWithoutComments(o) {
        var fragments;
        fragments = this.name.compileToFragmentsWithoutComments(o, LEVEL_LIST);
        if (this.question != null) {
          fragments.push(this.makeCode('?'));
        }
        if (this.explicitType != null) {
          fragments.push(this.makeCode(': '), ...this.explicitType.compileToFragmentsWithoutComments(o, LEVEL_LIST));
        }
        return fragments;
      }
