    ...
    class Rewriter {
      ...
      addImplicitBracesAndParens() {
        ...
        return this.scanTokens(function(token, i, tokens) {
          var endImplicitCall, endImplicitObject, forward, implicitObjectContinues, implicitObjectIndent, inControlFlow, inImplicit, inImplicitCall, inImplicitControl, inImplicitObject, isImplicit, isImplicitCall, isImplicitObject, k, newLine, nextTag, nextToken, offset, preContinuationLineIndent, preObjectToken, prevTag, prevToken, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, s, sameLine, stackIdx, stackItem, stackTag, stackTop, stackTop2, startIdx, startImplicitCall, startImplicitObject, startIndex, startTag, startsLine, tag, top2;
          [tag] = token;
          ...
          if (tag === 'INDENT' && inImplicit()) {
            ...
            if ((prevTag !== '=>' && prevTag !== '->' && prevTag !== '[' && prevTag !== '(' && prevTag !== ',' && prevTag !== '{' && prevTag !== 'ELSE' && prevTag !== '=') && !(inImplicitObject() && ((ref = stackTop2()) != null ? ref[0] : void 0) === '[' && ((ref1 = tokens[stackTop()[1] - 1]) != null ? ref1[0] : void 0) === ',')) {
          ...
          inControlFlow = () => {
            ...
            this.detectEnd(i, function(token, i) {
              var ref2;
              return ref2 = token[0], indexOf.call(LINEBREAKS, ref2) >= 0;
            }, function(token, i) {
              var first_line;
          ...
          if ((indexOf.call(IMPLICIT_FUNC, tag) >= 0 && token.spaced || tag === '?' && i > 0 && !tokens[i - 1].spaced) && (indexOf.call(IMPLICIT_CALL, nextTag) >= 0 || (nextTag === '...' && (ref2 = this.tag(i + 2), indexOf.call(IMPLICIT_CALL, ref2) >= 0) && !this.findTagsBackwards(i, ['INDEX_START', '['])) || indexOf.call(IMPLICIT_UNSPACED_CALL, nextTag) >= 0 && !nextToken.spaced && !nextToken.newLine) && !inControlFlow()) {
            if (tag === '?') {
          ...
          if (indexOf.call(IMPLICIT_FUNC, tag) >= 0 && this.indexOfTag(i + 1, 'INDENT') > -1 && this.looksObjectish(i + 2) && !this.findTagsBackwards(i, ['CLASS', 'EXTENDS', 'IF', 'CATCH', 'SWITCH', 'LEADING_WHEN', 'FOR', 'WHILE', 'UNTIL']) && !(((ref3 = (s = (ref4 = stackTop()) != null ? ref4[0] : void 0)) === '{' || ref3 === '[') && !isImplicit(stackTop()) && this.findTagsBackwards(i, s))) {
            startImplicitCall(i + 1);
          ...
          if (tag === ':') {
            ...
            s = (function() {
              var ref5;
              switch (false) {
                case ref5 = this.tag(i - 1), indexOf.call(EXPRESSION_END, ref5) < 0:
            ...
            startsLine = s <= 0 || (ref5 = this.tag(s - 1), indexOf.call(LINEBREAKS, ref5) >= 0) || tokens[s - 1].newLine;
            // Are we just continuing an already declared object?
            // Including the case where we indent on the line after an explicit '{'.
            if (stackTop()) {
              [stackTag, stackIdx] = stackTop();
              if ((stackTag === '{' || stackTag === 'INDENT' && ((ref6 = (top2 = stackTop2())) != null ? ref6[0] : void 0) === '{' && ((ref7 = tokens[top2[1]][2]) != null ? ref7 : tokens[top2[1]].origin[2]).last_line === ((ref8 = tokens[stackIdx - 1]) != null ? ref8[2].first_line : void 0) && (!isImplicit(top2) || startsLine && ((ref9 = tokens[top2[1] - 1]) != null ? ref9[0] : void 0) === ',')) && (startsLine || this.tag(s - 1) === ',' || this.tag(s - 1) === '{') && (ref10 = this.tag(s - 1), indexOf.call(UNFINISHED, ref10) < 0)) {
                return forward(1);
              }
            }
          ...
          if (tag === ',' && !this.looksObjectish(i + 1) && inImplicitObject() && !((ref11 = this.tag(i + 2)) === 'FOROF' || ref11 === 'FORIN') && (nextTag !== 'TERMINATOR' || !this.looksObjectish(i + 2))) {
