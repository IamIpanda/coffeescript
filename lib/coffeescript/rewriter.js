...
(function() {
  ...
  var EXPLICIT_TYPE_ANNOTATIONS, INVERSES, LINEBREAKS, Rewriter, UNFINISHED,
    ...
    class Rewriter {
      ...
      addImplicitBracesAndParens() {
        ...
        return this.scanTokens(function(token, i, tokens) {
          var implicitObjectIndent, nextToken, prevToken, ref, ref1, ref2, ref3, ref4, startIndex, startTag;
          var [tag] = token;
          ...
          if (tag === ':') {
            ...
            var startsLine = s <= 0 || (ref2 = this.tag(s - 1), indexOf.call(LINEBREAKS, ref2) >= 0) || tokens[s - 1].newLine;
  ...
  var NOT_IMPLICIT_BEFORE = EXPLICIT_TYPE_ANNOTATIONS;
  ...
  var EXPLICIT_TYPE_UNARY = ['keyof', 'unique', 'readonly'];
