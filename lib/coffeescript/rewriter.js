    ...
    class Rewriter {
      ...
      addImplicitBracesAndParens() {
        ...
        return this.scanTokens(function(token, i, tokens) {
          ...
          inExplicitType = () => {
            var isFunc, tagCurrentLine, typeSpecifier;
            typeSpecifier = this.findTagsBackwards(i, EXPLICIT_TYPE_OPS);
            if (!typeSpecifier) {
              return false;
            }
            isFunc = false;
      ...
      normalizeLines() {
        ...
        return this.scanTokens(function(token, i, tokens) {
          ...
          if (indexOf.call(SINGLE_LINERS, tag) >= 0 && this.tag(i + 1) !== 'INDENT' && !(tag === 'ELSE' && this.tag(i + 1) === 'IF') && !conditionTag) {
            ...
            inExplicitType = this.findTagsBackwards(i, EXPLICIT_TYPE_OPS);
