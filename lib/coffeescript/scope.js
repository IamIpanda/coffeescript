...
(function() {
  ...
  exports.Scope = Scope = class Scope {
    ...
    explicitType(name, explicitType) {
      ...
      return v != null ? delete v.laterVar : void 0; // force top var declaration for type sake
    }
    ...
    getExplicitType(name) {
      var ref;
      return (ref = this.get(name)) != null ? ref.explicitType : void 0;
    }
    ...
    laterVar(name) {
      ...
      var v = this.get(name);
      var later = (v != null ? v.type : void 0) === 'var' && !(v.laterVar || (v.comments != null) || (v.explicitType != null));
      if (later) {
        v.laterVar = true;
      }
      return later;
