...
(function() {
  ...
  exports.Scope = Scope = class Scope {
    ...
    explicitType(name, explicitType) {
      var v;
      v = this.get(name);
      return v != null ? v.explicitType = explicitType : void 0;
    }
    ...
    spliceVariables(start) {
      var i, j, ref, ref1;
      for (i = j = ref = start, ref1 = this.variables.length; (ref <= ref1 ? j < ref1 : j > ref1); i = ref <= ref1 ? ++j : --j) {
