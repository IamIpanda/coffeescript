...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    identifierToken() {
      var alias, colon, colonOffset, colonToken, id, idLength, inJSXTag, input, match, optional, optionalOffset, optionalToken, poppedToken, prev, prevprev, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, regExSuper, regex, sup, tag, tagToken, tokenData;
      ...
      if (id === 'as' && this.seenImport) {
        ...
        if ((ref1 = this.prevTag()) === 'DEFAULT' || ref1 === 'IMPORT_ALL' || ref1 === 'IDENTIFIER') {
          this.token('AS', id);
          return id.length;
        }
      }
      if (id === 'as' && this.seenExport) {
        if ((ref2 = this.prevTag()) === 'IDENTIFIER' || ref2 === 'DEFAULT') {
          this.token('AS', id);
          return id.length;
        }
      ...
      if (id === 'default' && this.seenExport && ((ref4 = this.prevTag()) === 'EXPORT' || ref4 === 'AS')) {
      ...
      if (tag === 'IDENTIFIER' && (indexOf.call(JS_KEYWORDS, id) >= 0 || indexOf.call(COFFEE_KEYWORDS, id) >= 0) && !(this.exportSpecifierList && indexOf.call(COFFEE_KEYWORDS, id) >= 0)) {
        tag = id.toUpperCase();
        if (tag === 'WHEN' && (ref6 = this.prevTag(), indexOf.call(LINEBREAKS, ref6) >= 0)) {
          tag = 'LEADING_WHEN';
        } else if (tag === 'FOR') {
          this.seenFor = {
    ...
    jsxToken() {
      var afterTag, end, endToken, firstChar, fullId, fullTagName, id, input, j, jsxTag, len, match, notMatch, offset, openingTagToken, prev, prevChar, properties, property, ref, tagToken, token, tokens;
      ...
      if (firstChar === '<') {
        ...
        if (!(match && (this.jsxDepth > 0 || (!(prev = this.prev()) || prev.spaced || (ref = prev[0], indexOf.call(COMPARABLE_LEFT_SIDE, ref) < 0)) && (!(notMatch = GENERIC_FUNCTION_NOT_JSX.exec(this.chunk)) || (notMatch[1] != null) && count(notMatch[1], '{') !== count(notMatch[1], '}'))))) {
          return 0;
        }
        [input, id] = match;
        fullId = id;
    ...
    literalToken() {
      ...
      if (prev && indexOf.call(['=', ...COMPOUND_ASSIGN], value) >= 0) {
        ...
        if (prev && prev[0] !== 'PROPERTY') {
          ...
          if ((message = isUnassignable(prev[1], origin[1])) && !Rewriter.prototype.findTagsBackwards.call(this, this.tokens.length - 1, EXPLICIT_TYPE_ANNOTATIONS)) {
      ...
      if (value === ';') {
        ...
        tag = 'SHIFT';
      } else if (indexOf.call(EXPLICIT_TYPE, value) >= 0) {
        tag = 'EXPLICIT_TYPE';
        ...
        if (value === '(' && !prev.spaced && (ref4 = prev[0], indexOf.call(CALLABLE, ref4) >= 0)) {
          ...
          tag = 'CALL_START';
        } else if (value === '[' && !/^\[\s*\]/.test(this.chunk) && (((ref5 = prev[0], indexOf.call(INDEXABLE, ref5) >= 0) && !prev.spaced) || (prev[0] === '::'))) { // `.prototype` can’t be a method you can call.
          tag = 'INDEX_START';
          switch (prev[0]) {
            case '?':
              prev[0] = 'INDEX_SOAK';
    ...
    unfinished() {
      var ref;
      return LINE_CONTINUER.test(this.chunk) || (ref = this.prevTag(), indexOf.call(UNFINISHED, ref) >= 0);
    }
  ...
  RESERVED = ['case', 'function', 'var', 'with', 'const', 'let', 'enum', 'native', 'implements', 'interface', 'package', 'private', 'protected', 'public', 'static'];
  ...
  GENERIC_FUNCTION_NOT_JSX = /^<[^<>]*>\s*(?:\(([^<>]*))?[-=]>/; // generic parameters
