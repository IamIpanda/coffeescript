  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    tokenize(code, opts = {}) {
      ...
      while (this.chunk = code.slice(i)) {
        consumed = this.identifierToken() || this.commentToken() || this.whitespaceToken() || this.lineToken() || this.stringToken() || this.numberToken() || this.jsxToken() || this.regexToken() || this.jsToken() || this.tsToken() || this.literalToken();
        // Update position.
    ...
    tsToken() {
      var match, tag, value;
      if (!(match = TYPESCRIPT.exec(this.chunk))) {
        return 0;
      }
      [value] = match;
      tag = value;
      if (indexOf.call(EXPLICIT_TYPE, value) >= 0) {
        tag = 'EXPLICIT_TYPE';
      }
    ...
    literalToken() {
      ...
      if (prev && indexOf.call(['=', ...COMPOUND_ASSIGN], value) >= 0) {
        ...
        if (prev && prev[0] !== 'PROPERTY') {
          ...
          if ((message = isUnassignable(prev[1], origin[1])) && !Rewriter.prototype.findTagsBackwards.call(this, this.tokens.length - 1, ['~', 'EXPLICIT_TYPE'])) {
