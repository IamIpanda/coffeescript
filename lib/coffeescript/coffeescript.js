...
(function() {
  ...
  var FILE_EXTENSIONS, compile, registerCompiled,
    indexOf = [].indexOf;
  ...
  exports.compile = compile = withPrettyErrors(function(code, options = {}) {
    ...
    if (options.inlineMap) {
      ...
      var sourceURL = `//# sourceURL=${(ref1 = options.filename) != null ? ref1 : 'coffeescript'}`;
      js = `${js}\n${sourceMapDataURI}\n${sourceURL}`;
    }
  ...
  var getSourceMap = function(filename, line, column) {
    var ref;
    ...
    // `<anonymous>` that matches the error.
      ...
      for (var i = ref1.length - 1; i >= 0; i += -1) {
        var map = ref1[i];
        var sourceLocation = map.sourceLocation([line - 1, column - 1]);
    ...
    if (sources[filename] != null) {
      var answer = compile(sources[filename][sources[filename].length - 1], {
        filename: filename,
        sourceMap: true,
