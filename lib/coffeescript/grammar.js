...
(function() {
  ...
  grammar = {
    ...
    Assign: [
      ...
      o('TypedIdentifier = Expression',
      function() {
        return new Assign($1,
      $3);
      }),
      o('TypedIdentifier = TERMINATOR Expression',
      function() {
        return new Assign($1,
      $4);
      }),
      o('TypedIdentifier = INDENT Expression OUTDENT',
      function() {
        return new Assign($1,
      $4);
      })
    ...
    Code: [
      ...
      o('ExplicitTypeParameters FuncGlyph Block',
      function() {
        return new Code([],
      $3,
      $2,
    ...
    CodeLine: [
      ...
      o('ExplicitTypeParameters FuncGlyph Line',
      function() {
        return new Code([],
      LOC(3)(Block.wrap([$3])),
      $2,
    ...
    Param: [
      ...
      o('ParamVar OptExplicitType = Expression',
      function() {
        return new Param($1,
      $2.type,
      $4);
    ...
    TypeSpecifier: [o('~'), o('EXPLICIT_TYPE')],
    TypedIdentifier: [
      o('Identifier TypeSpecifier ExplicitType',
      function() {
        return new AssignExplicitType($1,
      $3);
      }),
    ...
    TypableIdentifier: [o('Identifier'), o('TypedIdentifier')],
    ExplicitType: [
      o('IDENTIFIER',
      function() {
        return new ExplicitTypeIdentifier($1);
      }),
      ...
      o('Literal',
      function() {
        return new ExplicitTypeLiteral($1);
      }),
      o('VOID',
      function() {
        return new ExplicitTypeVoid($1);
      }),
      o('PARAM_START ParamList PARAM_END FuncGlyph INDENT ExplicitType OUTDENT',
      function() {
        return new ExplicitTypeFunction($2,
      $6,
      $4);
      }),
      o('FuncGlyph INDENT ExplicitType OUTDENT',
      function() {
        return new ExplicitTypeFunction([],
      $3,
      $1);
      }),
      o('ExplicitType [ ]',
      function() {
        return new ExplicitTypeArray($1);
      }),
      o('ExplicitType INDEX_START ExplicitType INDEX_END',
      function() {
        return new ExplicitTypeAccess($1,
      LOC(3)(new Index($3)));
      }),
      o('ExplicitType . Property',
      function() {
        return new ExplicitTypeAccess($1,
      LOC(3)(new Access($3)));
      }),
      o('ExplicitType :: Property',
      function() {
        return new ExplicitTypeAccess(new ExplicitTypeAccess($1,
      LOC(2)(new Access(new PropertyName('prototype'),
      {
          shorthand: true
        }))),
      LOC(3)(new Access($3)));
      }),
      o('ExplicitType < ExplicitTypeArguments >',
      function() {
        return new ExplicitTypeGeneric($1,
      $3);
      }),
      o('ExplicitType & ExplicitType',
      function() {
        return new ExplicitTypeOp($2,
      $1,
      $3);
      }),
      o('ExplicitType | ExplicitType',
      ...
      o('( ExplicitType )',
      function() {
        return new ExplicitTypeParens($2);
      }),
      o('{ ExplicitTypeObjectList OptComma }',
      function() {
        return new ExplicitTypeObject($2);
      }),
      o('EXPLICIT_TYPE_UNARY ExplicitType',
      function() {
        return new ExplicitTypeOp($1,
      $2);
      }),
      // `typeof` and `new`. `delete` will get detected by TS.
      o('UNARY ExplicitType',
      function() {
        return new ExplicitTypeOp($1,
      $2);
      })
    ...
    ExplicitTypeObjectProp: [
      o('Property : ExplicitType',
      function() {
        return new ExplicitTypeObjectProp($1,
      $3);
      }),
      o('Property ? : ExplicitType',
      function() {
    ...
    ExplicitTypeArguments: [
      ...
      o('ExplicitTypeArguments , ExplicitType',
      function() {
        return $1.concat($3);
      }),
    ...
    ExplicitTypeParameters: [
      o('< ExplicitTypeParameterList >',
      function() {
        return new ExplicitTypeParameters($2);
      })
    ],
    ...
    ExplicitTypeParameter: [
      o('Identifier'),
      o('Identifier = ExplicitType',
      function() {
        return new ExplicitTypeAssign($1,
      $3);
      }),
      o('Identifier = INDENT ExplicitType OUTDENT',
      function() {
        return new ExplicitTypeAssign($1,
      $4);
      })
    ...
    Class: [
      ...
      o('CLASS SimpleAssignable ExplicitTypeParameters',
      function() {
        return new Class($2,
      null,
      null,
    ...
    Export: [
      ...
      o('EXPORT TypableIdentifier = Expression',
      function() {
      ...
      o('EXPORT TypableIdentifier = TERMINATOR Expression',
      function() {
        return new ExportNamedDeclaration(LOC(2,
      5)(new Assign($2,
      $5,
      ...
      o('EXPORT TypableIdentifier = INDENT Expression OUTDENT',
      function() {
        return new ExportNamedDeclaration(LOC(2,
      6)(new Assign($2,
      $5,
  ...
  operators = [
    ...
    [
      'right',
      '[',
      'INDEX_START' // [ for array type specifier
    ],
    ['nonassoc',
    '++',
    '--'],
